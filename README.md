...
CodeAgent 是一个基于 AI 的智能代码协作系统，通过 GitHub Webhooks 自动处理 Issue 和 Pull Request，提供高质量的代码生成、修改和审查服务。

## 🎯 项目状态

**当前版本**: v0.x (稳定版)  
**下一版本**: v1.0 (开发中) - [查看 1.0 计划](docs/codeagent-v1.0-plan.md)

## ✨ 功能特性

### 当前版本 (v0.x)
- 🤖 **多 AI 模型支持** - Claude、Gemini 双引擎
- 🔄 **自动化工作流** - Issue 到 PR 的完整自动化
- 🐳 **灵活部署** - Docker 容器化 + 本地 CLI 双模式
- 🔒 **安全保障** - GitHub Webhook 签名验证
- 📁 **智能工作空间** - Git Worktree 临时空间管理
- 🛠️ **灵活配置** - 支持相对路径和多种配置方式

### v1.0 升级亮点 (开发中)
- 🧠 **丰富上下文理解** - 完整的 GitHub 历史和文件变更分析
- 🌿 **智能分支管理** - 基于事件类型的自动分支策略
- 🔄 **实时交互反馈** - 动态进度跟踪和用户通知
- 🎯 **事件驱动 Prompt** - 智能模板选择和内容生成
- 🛡️ **细粒度权限控制** - 完善的安全管理和审计
- 🖼️ **多模态支持** - 图片和多媒体内容处理

> 💡 **查看完整升级计划**: [CodeAgent 1.0 详细规划](docs/codeagent-v1.0-plan.md)
